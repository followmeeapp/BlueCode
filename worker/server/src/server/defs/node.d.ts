...
declare module "assert" {
    ...
    module internal {
        ...
        // BEGIN: Vows.js additions.

        // These are extensions from Vows.js, but I don't know how to extend this module in the vows.d.ts file,
        // so I'm just putting them here. See: http://vowsjs.org/#reference

        // equality
        export function epsilon(epsilon: number, action: number, expected: number, message?: string): void;

        // type
        export function isFunction(f: Function, message?: string): void;
        export function isObject(obj: {}, message?: string): void;
        export function isString(str: string, message?: string): void;
        export function isArray(ary: any[], message?: string): void;
        export function isNumber(num: number, message?: string): void;
        export function isBoolean(bool: boolean, message?: string): void;
        export function typeOf(instance: any, typename: string, message?: string): void;
        export function instanceOf(instance: any, constructor: Function, message?: string): void;

        // truth
        export function isTrue(bool: boolean, message?: string): void;
        export function isFalse(bool: boolean, message?: string): void;

        // null, undefined, NaN
        export function isNull(obj: any, message?: string): void;
        export function isNotNull(obj: any, message?: string): void;
        export function isUndefined(obj: any, message?: string): void;
        export function isNaN(num: number, message?: string): void;

        // inclusion
        export var include: {
          (ary: any[], element: any, message?: string): void;
          (obj: {}, key: string, message?: string): void;
          (str: string, substring: string, message?: string): void;
        }

        // regexp matching
        export function match(str: string, regex: RegExp, message?: string): void;

        // length
        export var lengthOf: {
          (ary: any[], expectedLength: number, message?: string): void;
          (str: string, expectedLength: number, message?: string): void;
        }

        // emptiness
        export var isEmpty: {
          (ary: any[], message?: string): void;
          (obj: {}, message?: string): void;
          (str: string, message?: string): void;
        }

        // END: Vows.js additions.
