...
@interface NotificationController () <LYRQueryControllerDelegate>
...
cellForRowAtIndexPath: (NSIndexPath *) indexPath
{
    ...
    cell.indicatorLabel.hidden = !announcementsInfo.isUnread;
...
- (void)
queryController: (LYRQueryController *)         controller
