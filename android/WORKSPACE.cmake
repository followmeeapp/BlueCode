...
set (BOOST_INC ${WORKSPACE}/bazel-android/external/boost)

set (GTEST_INC ${WORKSPACE}/bazel-android/external/gtest/include)
...
set (CAPNPROTO_INC ${WORKSPACE}/bazel-android)
