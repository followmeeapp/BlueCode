...
#ifndef CAPNP_INCLUDED_8fcf8fb2ae97aaa7_
#define CAPNP_INCLUDED_8fcf8fb2ae97aaa7_
...
CAPNP_DECLARE_SCHEMA(a2389ec3e5abb32f);
...
struct SyncInfo {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(a2389ec3e5abb32f, 3, 0)
    #if !CAPNP_LITE
...
class SyncInfo::Reader {
public:
  typedef SyncInfo Reads;
...
class SyncInfo::Builder {
public:
  typedef SyncInfo Builds;
...
#if !CAPNP_LITE
class SyncInfo::Pipeline {
public:
  typedef SyncInfo Pipelines;
...
inline  ::int64_t SyncInfo::Reader::getCardsVersion() const {
  return _reader.getDataField< ::int64_t>(
      0 * ::capnp::ELEMENTS);
}

inline  ::int64_t SyncInfo::Builder::getCardsVersion() {
  return _builder.getDataField< ::int64_t>(
      0 * ::capnp::ELEMENTS);
}
inline void SyncInfo::Builder::setCardsVersion( ::int64_t value) {
...
#endif  // CAPNP_INCLUDED_8fcf8fb2ae97aaa7_
