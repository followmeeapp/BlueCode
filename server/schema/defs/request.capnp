...
struct Request {
  ...
  kind :union {
    ...
    createSectionRequest @12 :import "section.capnp".CreateSectionRequest;
    createBackupRequest  @13 :import "backup.capnp".CreateBackupRequest;
    backupListRequest    @14 :import "backup.capnp".BackupListRequest;
    backupRequest        @15 :import "backup.capnp".BackupRequest;
  }
}
