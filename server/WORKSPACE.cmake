...
set (UWEBSOCKETS_LIB ${BAZEL_BIN}/uWebSockets/libuWebSockets_impl.a)
...
include_directories(${LMDB_INC} ${BOOST_INC} ${GTEST_INC} ${WEBSOCKETPP_INC} ${UWEBSOCKETS_INC} ${LIBUV_INC} ${CAPNPROTO_INC})
